				...
				$presetsWrapper.on('click', '.xts-add-new-preset', function(e) {
					...
					$.ajax({
						...
						data    : {
							...
							data     : data,
							priority : $presetsWrapper.find('form .xts-priority').val(),
							name     : $presetsWrapper.find('form .xts-input-edit-preset-rule').val(),
							preset   : currentID,
							security : nonceValue
						},
						dataType: 'json',
					...
					$presetsWrapper.find('.xts-presets-title .xts-presets-title-inner').text('').append('<input type="text" class="xts-name-preset" placeholder="Enter name" value="' + $form.val() + '">');
					...
					$(document).on('mouseup', function (e) {
						...
						$titleWrapper.find('.xts-presets-title-inner').text('').append(name);
