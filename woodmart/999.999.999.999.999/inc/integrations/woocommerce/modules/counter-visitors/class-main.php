...
class Main extends Singleton {
	...
	public function add_options() {
		...
		Options::add_field(
			array(
				...
				'name'        => esc_html__( 'Visitor counter', 'woodmart' ),
				'description' => esc_html__( 'Show the number of visitors that are currently viewing a product on the single product page.', 'woodmart' ),
				'type'        => 'switcher',
	...
	public function update_count_product_visits() {
		...
		$live_visits = intval( sanitize_text_field( $_POST['live_visits'] ) ); //phpcs:ignore

		wp_send_json(
			array(
				'count'     => $this->get_count_visits_in_db( $product_id, $live_visits ),
