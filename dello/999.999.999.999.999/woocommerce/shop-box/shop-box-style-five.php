...
<div <?php post_class( 'radiantthemes-shop-box matchHeight style-five' ); ?>>
	<div class="holder">
		<div class="pic">
			...
			?>
			<a href="<?php echo get_permalink( $product->get_id() ); ?>"><img class="primary-img" src="<?php the_post_thumbnail_url( 'shop_single' ); ?>" alt="Product Image">
				<img class="primary-hover-img" src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( $product->get_id() ), 'shop_single' )[0]; ?>" alt="Product Image">
			</a>
			<?php
		...
		<div class="product-description">
			<div class="product-description-inner ">
				...
				<div class="product-price">
					<?php echo wp_kses( $product->get_price_html(), 'rt-content' ); ?>
				</div>
				<?php
