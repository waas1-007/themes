		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<?php include get_parent_theme_file_path( 'woocommerce/shop-details-box/shop-details-box-style-five.php' ); ?>
...
<?php } else { ?>
	...
	<div class="wraper_shop_single <?php echo esc_html( radiantthemes_global_var( 'shop-details-style', '', false ) ); ?>">
		<?php if ( 'style-six' == radiantthemes_global_var( 'shop-details-style', '', false ) ) { ?>
			<!-- START SHOP SINGLE CONTENT -->
			<?php
			if ( ! empty( radiantthemes_global_var( 'shop-details-style', '', false ) ) ) {
				...
				include get_parent_theme_file_path( 'woocommerce/shop-details-box/shop-details-box-style-five.php' );
			}
			?>
			<!-- END SHOP SINGLE CONTENT -->
		<?php } else { ?>
