...
if ( is_front_page() && is_home() ) { ?>
	...
	<div class="wraper_inner_banner is-front-page-is-home">
...
<?php } elseif ( is_front_page() ) { ?>
	...
	if ( ! empty( $page_featured_image_url ) ) {
		?>
		<div class="wraper_inner_banner is-front-page" style="background-image:url('<?php echo esc_url( $page_featured_image_url ); ?>')">
	<?php } else { ?>
		<div class="wraper_inner_banner is-front-page">
	<?php } ?>
		<?php
		if (
...
<?php } elseif ( is_home() ) { ?>
	<!-- wraper_header_bannerinner -->
		<?php if ( is_singular( 'post' ) ) { ?>
			<div class="wraper_inner_banner is-home">
		<?php } else { ?>
			<div class="wraper_inner_banner is-home">
		<?php } ?>
			<?php
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								...
								<?php else : ?>
									...
									<?php } else { ?>
									<h2 class="title">
										<?php echo esc_html__( 'Events', 'dello' ); ?>
									</h2>
									<?php } ?>
...
<?php } elseif ( class_exists( is_shop()  || is_tax( 'product_cat' ) || is_tax( 'product_tag' ) ) ) { ?>
		<!-- wraper_header_bannerinner -->
		<?php
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								...
								<?php else : ?>
									...
									<?php } else { ?>
									<h2 class="title">
										<?php echo esc_html__( 'Search', 'dello' ); ?>
									</h2>
									<?php } ?>
