 ...
 */
function radiant_merlin_content_blog_page_title( $output ) {
	return 'Journal';
}
add_filter( 'merlin_content_blog_page_title', 'radiant_merlin_content_blog_page_title' );
 ...
 */
function radiant_merlin_unset_default_widgets_args( $widget_areas ) {
...
add_filter( 'merlin_unset_default_widgets_args', 'radiant_merlin_unset_default_widgets_args' );
 ...
 */
function radiant_generate_child_functions_php( $output, $slug ) {
...
add_filter( 'merlin_generate_child_functions_php', 'radiant_generate_child_functions_php', 10, 2 );
