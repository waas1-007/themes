...
add_filter( 'ignition_customizer_options', 'ignition_nozama_filter_ignition_customizer_options' );
/**
 ...
 * @return array
 */
function ignition_nozama_filter_ignition_customizer_options( $options ) {
	...
	$options = array_merge( $options, apply_filters( "ignition_customizer_{$section}_options", array(
		'theme_ajax_product_search_ajax_is_enabled'      => array(
			...
			'control_args' => array(
				'section'     => $section,
				'type'        => 'checkbox',
				'label'       => esc_html__( 'Enable AJAX functionality', 'ignition-nozama' ),
				'description' => esc_html__( 'When disabled, the search form will still be visible, however no search results will be suggested while typing.', 'ignition-nozama' ),
			),
		),
		'theme_ajax_product_search_thumbnail_is_visible' => array(
			...
			'control_args' => array(
				'section' => $section,
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Show thumbnails', 'ignition-nozama' ),
			),
		),
		'theme_ajax_product_search_excerpt_is_visible'   => array(
			...
			'control_args' => array(
				'section' => $section,
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Show excerpts', 'ignition-nozama' ),
			),
		),
		'theme_ajax_product_search_price_is_visible'     => array(
			...
			'control_args' => array(
				'section' => $section,
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Show prices', 'ignition-nozama' ),
			),
		),
	) ) );
