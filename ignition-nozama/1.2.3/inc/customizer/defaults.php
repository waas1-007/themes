...
add_filter( 'ignition_customizer_defaults', 'ignition_nozama_filter_ignition_customizer_defaults' );
/**
 ...
 * @return array
 */
function ignition_nozama_filter_ignition_customizer_defaults( $defaults ) {
	$theme = wp_get_theme();
	...
	$colors = array(
		...
		'body-bg'                => '#ffffff',
		'accent-color'           => '#F08804',
		'accent-color-alt'       => '#00A8DE',
		'text-color'             => '#4A4A4A',
		'text-color-light'       => '#8E8E8E',
		'text-on-accent'         => '#ffffff',
		'border-color'           => '#DDDDDD',

		'button-bg-color'        => '#F08804',
		'button-text-color'      => '#ffffff',
		'button-border-color'    => '#F08804',

		'input-background-color' => '#ffffff',
		'input-border-color'     => '#CCCCCC',
		'input-text-color'       => '#373737',
	);
	...
	$defaults = array_merge( $defaults, array(
		...
		'top_bar_layout_is_visible' => 0,

		'top_bar_content_area1' => __( 'Text or shortcode', 'ignition-nozama' ),
		'top_bar_content_area2' => '',
		'top_bar_content_area3' => __( 'Text or shortcode', 'ignition-nozama' ),

		'top_bar_colors_background' => '#273442',
		...
		'header_transparent_colors_border'                   => 'rgba(255, 255, 255, 0.2)',
		...
		'header_sticky_colors_background'               => '#212e3c',
		...
		'header_sticky_colors_border'                   => 'rgba(255, 255, 255, 0.1)',
		...
		'header_mobile_nav_colors_background' => '#212e3c',
		'header_mobile_nav_colors_link'       => $colors['white'],
		'header_mobile_nav_colors_border'     => 'rgba(255, 255, 255, 0.1)',
		...
		'page_title_colors_background'       => '#212e3c',
		...
		'footer_is_visible'                => 1,
		'footer_colors_background'         => '#283848',
		'footer_colors_background_image'   => ignition_image_bg_control_defaults(),
		'footer_colors_border'             => 'rgba(255, 255, 255, 0.1)',
		'footer_colors_title'              => $colors['white'],
		'footer_colors_text'               => $colors['white'],
		'footer_credits_colors_background' => '#283848',
		'footer_credits_colors_border'     => 'rgba(255, 255, 255, 0.1)',
		...
		/* translators: %s is the URL to the CSSIgniter website. */
			__( 'A theme by <a href="%s" rel="nofollow">CSSIgniter</a> - Powered by WordPress', 'ignition-nozama' ), 'https://www.cssigniter.com/'
		),
		...
		'theme_ajax_product_search_ajax_is_enabled'      => 1,
		'theme_ajax_product_search_thumbnail_is_visible' => 1,
		'theme_ajax_product_search_excerpt_is_visible'   => 1,
		'theme_ajax_product_search_price_is_visible'     => 1,
	) );
	// phpcs:enable
