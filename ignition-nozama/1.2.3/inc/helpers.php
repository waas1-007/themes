 ...
 */
function ignition_nozama_asset_version( $version = false ) {
 ...
 */
function ignition_nozama_get_allowed_tags( $context = '' ) {
	$allowed = array(
		'a'       => array(
			'href'   => true,
			'title'  => true,
	 ...
	 */
	return apply_filters( 'ignition_nozama_get_allowed_tags', $allowed, $context );
}
