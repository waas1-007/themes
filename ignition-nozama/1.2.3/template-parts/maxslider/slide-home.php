...
/**
 * Contains template variables passed by MaxSlider.
 *
		...
		<div class="maxslider-slide-content <?php echo esc_attr( $align_classes ); ?>">
			<div class="maxslider-slide-content-pad">
				...
				<?php if ( ! empty( $slide['button'] ) && ! empty( $slide['button_url'] ) ) : ?>
					<a href="<?php echo esc_url( $slide['button_url'] ); ?>" class="maxslider-btn btn <?php echo esc_attr( $slide['button_size'] ); ?>">
						<?php echo wp_kses( $slide['button'], MaxSlider()->sanitizer->allowed_tags( 'button' ) ); ?>
					</a>
				<?php endif; ?>
			</div>

			<div class="ignition-slideshow-actions-wrap">
				<div class="ignition-slideshow-actions">
					<div class="ignition-slideshow-dots"></div>
					<div class="ignition-slideshow-arrows"></div>
				</div>
			</div>
		</div>
	</div>
