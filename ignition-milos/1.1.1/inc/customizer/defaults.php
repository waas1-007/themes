...
add_filter( 'ignition_customizer_defaults', 'ignition_milos_filter_ignition_customizer_defaults' );
/**
 ...
 * @return array
 */
function ignition_milos_filter_ignition_customizer_defaults( $defaults ) {
	$theme = wp_get_theme();
	...
	$colors = array(
		...
		'button-bg-color'        => '#00a9ef',
		'button-text-color'      => '#ffffff',
		'button-border-color'    => '#00a9ef',
	...
	$defaults = array_merge( $defaults, array(
		...
		'top_bar_content_area1' => __( 'Text or shortcode', 'ignition-milos' ),
		'top_bar_content_area2' => '',
		'top_bar_content_area3' => __( 'Text or shortcode', 'ignition-milos' ),
		...
		'blog_archive_posts_layout_type'          => '1col',
		...
		/* translators: %s is the URL to the CSSIgniter website. */
			__( 'A theme by <a href="%s" rel="nofollow">CSSIgniter</a> - Powered by WordPress', 'ignition-milos' ), 'https://www.cssigniter.com/'
		),
