...
if ( ! defined( 'IGNITION_MILOS_NAME' ) ) {
	 ...
	 * The theme's slug.
	 */
	define( 'IGNITION_MILOS_NAME', 'ignition-milos' );
}

add_action( 'after_setup_theme', 'ignition_milos_setup' );
/**
 ...
 */
function ignition_milos_setup() {
	// Default content width.
	$GLOBALS['content_width'] = 870;

	// Make theme available for translation.
	load_theme_textdomain( 'ignition-milos', get_template_directory() . '/languages' );

	// Image sizes
	set_post_thumbnail_size( 870, 580, true );
	add_image_size( 'ignition_item', 615, 410, true );
	add_image_size( 'ignition_item_tall', 750, 850, true );
	...
	add_theme_support( 'ignition-accommodation' );
	// Typography.
	...
	add_theme_support( 'editor-color-palette', array(
		array(
			'name'  => __( 'Primary color', 'ignition-milos' ),
			'slug'  => 'theme-primary',
			'color' => '#00a9ef',
		),
		array(
			'name'  => __( 'Dark gray', 'ignition-milos' ),
			'slug'  => 'theme-dark-gray',
			'color' => '#444444',
		),
		array(
			'name'  => __( 'Medium gray', 'ignition-milos' ),
			'slug'  => 'theme-medium-gray',
			'color' => '#888888',
		),
		array(
			'name'  => __( 'Light gray', 'ignition-milos' ),
			'slug'  => 'theme-light-gray',
			'color' => '#ebebeb',
		),
		array(
			'name'  => __( 'White', 'ignition-milos' ),
			'slug'  => 'theme-white',
			'color' => '#ffffff',
		),
		array(
			'name'  => __( 'Black', 'ignition-milos' ),
			'slug'  => 'theme-black',
			'color' => '#000000',
		),
	) );
