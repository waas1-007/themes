                    ...
                    <?php endif; ?>
		                ...
		                <?php if (!$this->is_subscription): ?>
                            ...
                            <?php esc_html_e('Due to the Envato\'s license policy one standard license is valid only for 1 project.', 'xstore'); ?>
                                ...
                                <br> If you want to use this theme unlimited (multiple projects), please check our <a href="https://www.8theme.com/woocommerce-themes/#price-section-anchor" target="_blank">8theme's subscription plan.</a>
                            </p>
		                <?php endif; ?>
            <?php else: ?>
