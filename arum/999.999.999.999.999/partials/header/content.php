...
$logo = arum_get_option('logo');
$default_logo = get_theme_file_uri('/assets/images/logo.svg');
?>
                            ...
                            <div class="hm-res_m-pos--left lahb-responsive-menu-wrap lahb-responsive-menu-1546041916358" data-uniqid="1546041916358">
                                ...
                                <ul class="responav menu">
                                    ...
                                    $menu_output = wp_nav_menu( array(
                                        ...
                                        'items_wrap'    => '%3$s',
                                        'echo'          => false,
                                        'fallback_cb'   => array( 'Arum_MegaMenu_Walker', 'fallback' ),
                                        'walker'        => new Arum_MegaMenu_Walker
                                    ));
                                    echo arum_render_variable($menu_output);
                                    ?>
                                </ul>
                            </div>
                            <nav class="lahb-element lahb-nav-wrap nav__wrap_1546041916358 " data-uniqid="1546041916358"><ul class="menu"><?php echo arum_render_variable($menu_output); ?></ul></nav>
                        </div>
                    </div>
                </div>
            </div>
