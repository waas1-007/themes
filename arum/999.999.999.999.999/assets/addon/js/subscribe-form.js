(function ($) {
    ...
    var LaStudioAjaxHandler = function (options) {
         ...
         * @type {Object}
         */
        self.handlerSettings = la_theme_config.subscribeForm || {};
        ...
        if ('' === settings.url) {
            ...
            settings.url = la_theme_config.ajax_url;
        }
    ...
    var LaStudioSubscribeForm = function( $scope ) {
        var $target = $scope.find('.lastudio-subscribe-form'),
            ...
            timeout = null,
            invalidMailMessage = la_theme_config.sys_messages.invalid_mail;
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/lastudio-subscribe-form.default', function ($scope) {
            LaStudioSubscribeForm($scope);
        });
    });

    $(function () {
        $('.custom-sf-shortcode').each(function () {
            LaStudioSubscribeForm($(this));
        })
    })
