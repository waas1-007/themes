...
<?php
$page_loading_bgcolor = arum_get_option('page_loading_bgcolor', '#fff');
$page_loading_textcolor = arum_get_option('page_loading_textcolor', '#181818');
?>
.la-image-loading{
...
<?php if( arum_get_option('catalog_mode', 'off') == 'on' && arum_get_option('catalog_mode_price', 'off') == 'on' ){ ?>
