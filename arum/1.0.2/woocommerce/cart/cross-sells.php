...
<?php
    ...
    $product_cols = arum_get_responsive_columns('crosssell_products_columns');
	...
	$loopCssClass[] = arum_get_responsive_column_classes('crosssell_products_columns', array(
        'mobile' => 1,
        'tablet' => 1
    ));

	$title = arum_get_option('crosssell_product_title');
	$sub_title = arum_get_option('crosssell_product_subtitle');
			...
			<div class="col-xs-12">
                <h2 class="block_heading--title"><span><?php
                        if(!empty($title)){
                            ...
                            echo _x( 'You may be interested in&hellip;', 'front-view', 'arum' );
                        }
                        ?></span></h2>
