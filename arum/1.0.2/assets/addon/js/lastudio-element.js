(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        function lastudio_tabs_func( $scope ){
        ...
        function lastudio_circle_progress_func( $scope ){
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/widget', function ($scope) {
            ...
            var _widget_type = $scope.data('widget_type');

            switch (_widget_type){
                case 'image-gallery.default':
                    $scope.find('br').remove();
                    break;

                case 'lastudio-tabs.default':
                    lastudio_tabs_func($scope);
                    break;

                case 'lastudio-circle-progress.default':
                    lastudio_circle_progress_func($scope);
                    break;
            }
        });
