...
$enable_related = arum_get_option('blog_related_posts', 'off');
$related_style  = arum_get_option('blog_related_design', 1);
$max_related    = arum_get_option('blog_related_max_post', 1);
$related_by     = arum_get_option('blog_related_by', 'random');
...
if(!arum_string_to_bool($enable_related)){
    return;
}

$related_columns = arum_get_responsive_columns('blog_related_post_columns');
...
if($related_query->have_posts()){
    ...
    <div class="section-related-posts related-posts-design-<?php echo esc_attr($related_style); ?><?php if($move_related_to_bottom){ echo ' related-post-after-main'; } ?>">
        ...
        <h3 class="related-posts-heading theme-heading"><?php esc_html_e('Related Posts', 'arum'); ?></h3>
