 ...
 * @return mixed
 */
function ignition_decorist_ignition_customizer_defaults( $setting = false ) {
 ...
 * @return string
 */
function ignition_decorist_ignition_scripts_styles_suffix() {
 ...
 * @return mixed
 */
function ignition_decorist_ignition_get_mod( $name, $default = false ) {
