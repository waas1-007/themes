...
add_filter( 'ignition_header_layout_menu_types', 'ignition_decorist_ignition_header_layout_menu_types' );
/**
 ...
 * @return array
 */
function ignition_decorist_ignition_header_layout_menu_types( $menu_types ) {
	...
	$menu_types['theme'] = array(
		'title'         => __( 'Theme Default', 'ignition-decorist' ),
