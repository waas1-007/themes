...
add_filter( 'ignition_customizer_defaults', 'ignition_decorist_filter_ignition_customizer_defaults' );
/**
 ...
 * @return array
 */
function ignition_decorist_filter_ignition_customizer_defaults( $defaults ) {
	$theme = wp_get_theme();
	...
	$colors = array(
		...
		'button-bg-color'        => '#ea2c2c',
		'button-text-color'      => '#ffffff',
		'button-border-color'    => '#ea2c2c',
	...
	$defaults = array_merge( $defaults, array(
		...
		'top_bar_content_area1' => __( 'Text or shortcode', 'ignition-decorist' ),
		'top_bar_content_area2' => '',
		'top_bar_content_area3' => __( 'Text or shortcode', 'ignition-decorist' ),

		'top_bar_colors_background' => '#f9f9f9',
		...
		'header_transparent_colors_border'                   => 'rgba(255, 255, 255, 0.1)',
		...
		'page_title_colors_background'       => '#f5f5f5',
		...
		'footer_credits_colors_background' => '#f9f9f9',
		...
		/* translators: %s is the URL to the CSSIgniter website. */
			__( 'A theme by <a href="%s" rel="nofollow">CSSIgniter</a> - Powered by WordPress', 'ignition-decorist' ), 'https://www.cssigniter.com/'
		),
