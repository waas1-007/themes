...
add_filter( 'stylesheet_uri', 'ignition_decorist_stylesheet_uri', 10, 2 );
/**
 ...
 * @return string
 */
function ignition_decorist_stylesheet_uri( $stylesheet_uri, $stylesheet_dir_uri ) {
	if ( ! is_child_theme() ) {
...
add_filter( 'get_archives_link', 'ignition_decorist_wrap_archive_widget_post_counts_in_span', 10, 2 );
/**
 ...
 * @return string
 */
function ignition_decorist_wrap_archive_widget_post_counts_in_span( $output ) {
...
add_filter( 'wp_list_categories', 'ignition_decorist_wrap_category_widget_post_counts_in_span', 10, 2 );
/**
 ...
 * @return string
 */
function ignition_decorist_wrap_category_widget_post_counts_in_span( $output, $args ) {
