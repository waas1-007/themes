...
add_action( 'wp_loaded', 'ignition_convert_register_data_upgrade', 1000 );
/**
 ...
 * @since 1.0.0
 */
function ignition_convert_register_data_upgrade() {
	$upgrader = new Ignition_Convert_Data_Upgrade();
