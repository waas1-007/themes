...
add_filter( 'ignition_customizer_defaults', 'ignition_amaryllis_filter_ignition_customizer_defaults' );
/**
 ...
 * @return array
 */
function ignition_amaryllis_filter_ignition_customizer_defaults( $defaults ) {
	$theme = wp_get_theme();
	...
	$defaults = array_merge( $defaults, array(
		...
		'top_bar_content_area1' => __( 'Text or shortcode', 'ignition-amaryllis' ),
		'top_bar_content_area2' => '',
		'top_bar_content_area3' => __( 'Text or shortcode', 'ignition-amaryllis' ),

		'top_bar_colors_background' => $colors['accent-color-alt'],
		'top_bar_colors_text'       => $colors['black'],
		'top_bar_colors_border'     => 'rgba(0, 0, 0, 0)',

		'top_bar_transparent_colors_background' => $colors['accent-color-alt'],
		'top_bar_transparent_colors_text'       => $colors['black'],
		'top_bar_transparent_colors_border'     => 'rgba(0, 0, 0, 0)',

		'header_layout_type'                   => 'normal',
		'header_layout_menu_type'              => 'split',
		...
		'header_colors_text'               => $colors['text-color-light'],
		...
		'header_sticky_colors_text'               => $colors['text-color-light'],
		...
		'header_mobile_nav_colors_link'       => $colors['text-color-light'],
		...
		'page_title_with_background_text_align_horizontal' => 'center',
		'page_title_with_background_text_align_vertical'   => 'center', // Theme config value. 'top', 'middle', 'bottom'
		...
		'page_title_colors_background'       => $colors['accent-color-alt'],
		...
		'footer_is_visible'                => 1,
		'footer_colors_background'         => '#f2f2f2',
		...
		'footer_credits_colors_background' => '#f2f2f2',
		...
		/* translators: %s is the URL to the CSSIgniter website. */
			__( 'A theme by <a href="%s" rel="nofollow">CSSIgniter</a> - Powered by WordPress', 'ignition-amaryllis' ), 'https://www.cssigniter.com/'
		),
