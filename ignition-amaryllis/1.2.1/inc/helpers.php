 ...
 */
function ignition_amaryllis_asset_version( $version = false ) {
 ...
 */
function ignition_amaryllis_get_allowed_tags( $context = '' ) {
	$allowed = array(
		'a'       => array(
			'href'   => true,
			'title'  => true,
	 ...
	 */
	return apply_filters( 'ignition_amaryllis_get_allowed_tags', $allowed, $context );
}
