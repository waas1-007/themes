...
add_filter( 'ignition_customizer_options', 'ignition_amaryllis_filter_ignition_customizer_options' );
/**
 ...
 * @return array
 */
function ignition_amaryllis_filter_ignition_customizer_options( $options ) {
