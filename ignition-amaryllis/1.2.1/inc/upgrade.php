...
add_action( 'wp_loaded', 'ignition_amaryllis_register_data_upgrade', 1000 );
/**
 ...
 * @since 1.0.0
 */
function ignition_amaryllis_register_data_upgrade() {
	$upgrader = new Ignition_Amaryllis_Data_Upgrade();
