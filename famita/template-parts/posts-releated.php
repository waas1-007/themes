<?php
    $relate_count = famita_get_config('number_blog_releated', 2);
    $relate_columns = famita_get_config('releated_blog_columns', 2);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'famita' ); ?></span>
    </h4>
