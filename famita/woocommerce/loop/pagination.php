...
$pagination_type = famita_get_config('product_pagination', 'default');
...
?>
	<div class="ajax-pagination <?php echo trim($pagination_type == 'loadmore' ? 'loadmore-action' : 'infinite-action'); ?>">
		...
		<a href="#" class="apus-loadmore-btn"><?php esc_html_e( 'load more items', 'famita' ); ?></a>
		<a href="#" class="apus-allproducts"><?php esc_html_e( 'All products loaded.', 'famita' ); ?></a>
	</div>
<?php
} else {
?>
