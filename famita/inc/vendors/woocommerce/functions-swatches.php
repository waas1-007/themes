...
if ( !class_exists("Famita_Woo_Swatches") ) {
	class Famita_Woo_Swatches {

		public static function swatches_list( $image_size = 'woocommerce_thumbnail' ) {

			$show_swatches = famita_get_config( 'show_product_swatches_on_grid' );
			if ( !$show_swatches || !famita_is_woo_swatches_activated() ) {
				return;
			}
			...
			$attribute_name = famita_get_config('product_swatches_attribute');
			...
			echo apply_filters( 'famita_swatches_list', $output, $product_id, $product );
		}
