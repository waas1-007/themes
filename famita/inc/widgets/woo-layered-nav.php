...
class Famita_Widget_Woo_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a list of attributes to filter products in your store.', 'famita' );
		$this->widget_id          = 'apus_woocommerce_layered_nav';
		$this->widget_name        = esc_html__( 'Apus Filter Products by Attribute', 'famita' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			...
			'attribute' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'famita' ),
				'options' => $attribute_array,
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'famita' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'famita' ),
					'or'  => esc_html__( 'OR', 'famita' ),
				),
			),
		);
	}
...
register_widget( 'Famita_Widget_Woo_Layered_Nav' );