...
class Famita_Custom_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'famita'),
            array( 'description' => esc_html__( 'Show custom menu', 'famita' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'famita' ); ?>
            </label>
            <br>
...
register_widget( 'Famita_Custom_Menu' );