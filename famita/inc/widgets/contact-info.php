...
class Famita_Widget_Contact_Info extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_contact_info',
            esc_html__('Apus Contact Info Widget', 'famita'),
            array( 'description' => esc_html__( 'Show Contact Info', 'famita' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <div class="address-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'address_icon' )); ?>"><?php esc_html_e( 'Icon:', 'famita' ); ?></label>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'address_content' )); ?>"><strong><?php esc_html_e('Address Content:', 'famita');?></strong></label>
        ...
        <div class="phone-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'phone_icon' )); ?>"><?php esc_html_e( 'Icon:', 'famita' ); ?></label>
            <div class="screenshot">
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'phone_content' )); ?>"><strong><?php esc_html_e('Phone Content:', 'famita');?></strong></label>
        ...
        <div class="email-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'email_icon' )); ?>"><?php esc_html_e( 'Icon:', 'famita' ); ?></label>
            <div class="screenshot">
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'email_content' )); ?>"><strong><?php esc_html_e('Email Content:', 'famita');?></strong></label>
...
register_widget( 'Famita_Widget_Contact_Info' );