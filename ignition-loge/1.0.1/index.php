...
<main class="main">
	...
	<?php
		$featured = ignition_loge_get_featured_article();

		if ( false !== $featured && $featured->have_posts() ) {
			...
			<div id="content-row" class="<?php ignition_the_container_classes(); ?>">
				<?php
					if ( have_posts() ) :
						...
						$layout  = get_theme_mod( 'blog_archive_posts_layout_type', ignition_loge_ignition_customizer_defaults( 'blog_archive_posts_layout_type' ) );
						$classes = array();
