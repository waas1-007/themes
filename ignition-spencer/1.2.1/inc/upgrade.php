...
add_action( 'wp_loaded', 'ignition_spencer_register_data_upgrade', 1000 );
/**
 ...
 * @since 1.0.0
 */
function ignition_spencer_register_data_upgrade() {
	$upgrader = new Ignition_Spencer_Data_Upgrade();
