...
add_filter( 'ignition_customizer_defaults', 'ignition_medi_filter_ignition_customizer_defaults' );
/**
 ...
 * @return array
 */
function ignition_medi_filter_ignition_customizer_defaults( $defaults ) {
	$theme = wp_get_theme();
	...
	$colors = array(
		...
		'body-bg'                => '#ffffff',
		'accent-color'           => '#132739',
		'accent-color-alt'       => '#34a4c6',
		'text-color'             => '#212121',
		'text-color-light'       => '#757575',
		'text-on-accent'         => '#ffffff',
		'border-color'           => '#dddddd',

		'button-bg-color'        => '#34a4c6',
		'button-text-color'      => '#ffffff',
		'button-border-color'    => '#34a4c6',
	...
	$defaults = array_merge( $defaults, array(
		...
		'top_bar_content_area1' => __( 'Text or shortcode', 'ignition-medi' ),
		'top_bar_content_area2' => '',
		'top_bar_content_area3' => __( 'Text or shortcode', 'ignition-medi' ),
		...
		'page_title_colors_overlay'          => 'rgba(19, 39, 57, 0.61)',
		...
		'footer_is_visible'                => 1,
		'footer_colors_background'         => '#142739',
		'footer_colors_background_image'   => ignition_image_bg_control_defaults(),
		'footer_colors_border'             => '#00455e',
		'footer_colors_title'              => $colors['white'],
		'footer_colors_text'               => $colors['white'],
		'footer_credits_colors_background' => '#142739',
		'footer_credits_colors_border'     => '#00455e',
		...
		/* translators: %s is the URL to the CSSIgniter website. */
			__( 'A theme by <a href="%s" rel="nofollow">CSSIgniter</a> - Powered by WordPress', 'ignition-medi' ), 'https://www.cssigniter.com/'
		),
