...
if ( ! function_exists( 'awb_get_carousel_nav' ) ) {
	...
	function awb_get_carousel_nav( $prev_class = '', $next_class = '' ) {
		...
		$html .= '<button class="' . esc_attr( $prev_class ) . '" aria-label="' . esc_attr__( 'Previous', 'Avada' ) . '"></button>';
		$html .= '<button class="' . esc_attr( $next_class ) . '" aria-label="' . esc_attr__( 'Next', 'Avada' ) . '"></button>';
		$html .= '</div>';
